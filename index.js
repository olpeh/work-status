...
(function(e) {
  ...
  function r(T) {
    ...
    if (z !== M) {
      T[0] = z;
      e:
        for (var Y = 0, G = T.length, xt = G >>> 1; Y < xt; ) {
          var ft = 2 * (Y + 1) - 1, Wt = T[ft], pt = ft + 1, mn = T[pt];
          if (0 > i(Wt, z))
            pt < G && 0 > i(mn, Wt) ? (T[Y] = mn, T[pt] = z, Y = pt) : (T[Y] = Wt, T[ft] = z, Y = ft);
          else if (pt < G && 0 > i(mn, z))
            T[Y] = mn, T[pt] = z, Y = pt;
          else
            break e;
        }
...
function ka(e, t) {
  switch (X(ri, t), X(ni, e), X(wt, Ni), e = t.nodeType, e) {
    case 9:
    case 11:
...
function Uu(e, t, n, r, i) {
  ...
  if (ir(t, i), t.stateNode === null)
    ...
    s = t.stateNode, Pd(e, t), l = t.memoizedProps, u = t.type === t.elementType ? l : tt(t.type, l), s.props = u, h = t.pendingProps, m = s.context, a = n.contextType, typeof a == "object" && a !== null ? a = qe(a) : (a = Ae(n) ? Cn : Ce.current, a = ar(t, a));
...
function om(e, t, n, r, i, o, s) {
  ...
  return i.data === "$?" ? (t.flags |= 128, t.child = e.child, t = gm.bind(null, e), i._reactRetry = t, null) : (e = o.treeContext, $e = en(i.nextSibling), Ue = t, ee = !0, rt = null, e !== null && (Qe[Xe++] = Pt, Qe[Xe++] = Lt, Qe[Xe++] = Tn, Pt = e.id, Lt = e.overflow, Tn = t), t = Pa(t, r.children), t.flags |= 4096, t);
}
function Bu(e, t, n) {
  e.lanes |= t;
  var r = e.alternate;
...
const ic = (e, t) => {
...
}, bm = (e, t) => ai(e) == ai(t), [Af, ev] = qm(/* @__PURE__ */ new Map()), tv = an(
  {
    // events
    onLoadingSlow: Kt,
    onSuccess: Kt,
  ...
  return n;
}, rv = ae.createContext({}), iv = "$inf$", Ff = os && window.__SWR_DEVTOOLS_USE__, ov = Ff ? window.__SWR_DEVTOOLS_USE__ : [], sv = () => {
  ...
  null,
  (e[1] === null ? e[2] : e[1]) || {}
], av = () => an(tv, ae.useContext(rv)), uv = (e) => (t, n, r) => e(t, n && ((...o) => {
  ...
  const r = av(), [i, o, s] = lv(n), l = nv(r, s);
  let a = e;
  const { use: u } = l, p = (u || []).concat(cv);
...
const oc = Zo.use || ((e) => {
  ...
  const { cache: r, compare: i, suspense: o, fallbackData: s, revalidateOnMount: l, revalidateIfStale: a, refreshInterval: u, refreshWhenHidden: p, refreshWhenOffline: h, keepPreviousData: m } = n, [y, w, k, F] = Ot.get(r), [d, c] = Ua(e), f = ae.useRef(!1), v = ae.useRef(!1), x = ae.useRef(d), S = ae.useRef(t), C = ae.useRef(n), E = () => C.current, H = () => E().isVisible() && E().isOnline(), [D, pe, dt, Ve] = Df(r, d), he = ae.useRef({}).current, as = $(s) ? n.fallback[d] : s, zn = (K, q) => {
    for (const ke in he) {
      const se = ke;
      if (se === "data") {
  ...
  ), An[0], An[1]), M = !f.current, z = y[d] && y[d].length > 0, Y = T.data, G = $(Y) ? as : Y, xt = T.error, ft = ae.useRef(G), Wt = m ? $(Y) ? ft.current : Y : G, pt = z && !$(xt) ? !1 : M && !$(l) ? l : E().isPaused() ? !1 : o ? $(G) ? !1 : a : $(G) || a, mn = !!(d && t && M && pt), ep = $(T.isValidating) ? mn : T.isValidating, tp = $(T.isLoading) ? mn : T.isLoading, _r = ae.useCallback(
    async (K) => {
      const q = S.current;
...
}) => Zf((n) => n instanceof e, t), Bf = it.create, Hf = un.create, Dv = Vo.create, Mv = cn.create, Yf = fi.create, Iv = Ln.create, jv = jo.create, zv = pi.create, Av = hi.create, Fv = mr.create, Vv = En.create, Wv = Ft.create, $v = zo.create, Uv = at.create, Zv = te.create, Bv = te.strictCreate, Hv = mi.create, Yv = ss.create, Qv = vi.create, Xv = kt.create, Gv = yi.create, Kv = Ao.create, qv = Rn.create, Jv = sr.create, bv = gi.create, e0 = wi.create, t0 = dn.create, n0 = _i.create, r0 = vr.create, lc = ct.create, i0 = Mt.create, o0 = Dn.create, s0 = ct.createWithPreprocess, l0 = Oi.create, a0 = () => Bf().optional(), u0 = () => Hf().optional(), c0 = () => Yf().optional(), d0 = {
...
function Rr(e) {
  return (t, n = {}) => {
    ...
    if (!o)
      return null;
    const s = o[0], l = r && e.parsePatterns[r] || e.parsePatterns[e.defaultParseWidth], a = Array.isArray(l) ? W0(l, (h) => h.test(s)) : (
...
const hc = (e) => {
  ...
  return console.log(t, n, r), /* @__PURE__ */ Q.jsxs("main", { className: et.app, children: [
