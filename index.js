...
const pc = (e) => {
  ...
  switch (console.log(e), !0) {
    ...
    case ("ContributionAmount" in e && "MemberCount" in e):
      return (e.ContributionAmount / 200).toLocaleString("fi-FI", { maximumFractionDigits: 1 }) + "%";
    default:
      return e.ContributionAmount;
  }
}, kg = (e) => {
  const t = e.AHStatus.ContributionAmount, n = e.BUKStatus.OnTrackCount / e.BUKStatus.MemberCount, r = e.SamvirkStatus.ContributionAmount / 200;
  return (t * n * r).toLocaleString("fi-FI", { maximumFractionDigits: 1 });
}, Sg = async (e) => {
  console.log("prod");
  let t;
      ...
      /* @__PURE__ */ Q.jsxs("li", { children: [
        ...
        /* @__PURE__ */ Q.jsxs("table", { children: [
          ...
          /* @__PURE__ */ Q.jsx("tbody", { children: i.Teams.map((o) => /* @__PURE__ */ Q.jsxs("tr", { children: [
            ...
            /* @__PURE__ */ Q.jsx("td", { children: Bs(o.SamvirkStatus) }),
            /* @__PURE__ */ Q.jsx("td", { children: kg(o) })
          ] }, o.Name)) })
        ] })
      ] })
    ] }, i.Title)) }) })
