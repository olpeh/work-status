...
var Gl = Ql.prototype = new _c();
Gl.constructor = Ql;
gc(Gl, yr.prototype);
Gl.isPureReactComponent = !0;
var Ga = Array.isArray, kc = Object.prototype.hasOwnProperty, Xl = { current: null }, Sc = { key: !0, ref: !0, __self: !0, __source: !0 };
function xc(e, t, n) {
...
function Gi(e, t, n, r, i) {
  ...
  if (s)
    return s = e, i = i(s), e = r === "" ? "." + ds(s, 0) : r, Ga(i) ? (n = "", e != null && (n = e.replace(Xa, "$&/") + "/"), Gi(i, t, n, "", function(u) {
      return u;
    })) : i != null && (Kl(i) && (i = mp(i, n + (!i.key || s && s.key === i.key ? "" : ("" + i.key).replace(Xa, "$&/") + "/") + e)), t.push(i)), 1;
  if (s = 0, r = r === "" ? "." : r + ":", Ga(e))
    ...
    for (e = a.call(e), l = 0; !(o = e.next()).done; )
      o = o.value, a = r + ds(o, l++), s += Gi(o, t, n, a, i);
  else if (o === "object")
...
(function(e) {
  ...
  function r(T) {
    ...
    if (z !== M) {
      T[0] = z;
      e:
        for (var Y = 0, X = T.length, St = X >>> 1; Y < St; ) {
          var dt = 2 * (Y + 1) - 1, Wt = T[dt], ft = dt + 1, mn = T[ft];
          if (0 > i(Wt, z))
            ft < X && 0 > i(mn, Wt) ? (T[Y] = mn, T[ft] = z, Y = ft) : (T[Y] = Wt, T[dt] = z, Y = dt);
          else if (ft < X && 0 > i(mn, z))
            T[Y] = mn, T[ft] = z, Y = ft;
          else
            break e;
        }
...
function ru(e) {
  if (e = Ti(e)) {
    if (typeof ol != "function")
      throw Error(g(280));
    var t = e.stateNode;
    t && (t = Go(t), ol(e.stateNode, e.type, t));
  }
}
function $c(e) {
...
function Xp(e, t) {
  for (var n = e.suspendedLanes, r = e.pingedLanes, i = e.expirationTimes, o = e.pendingLanes; 0 < o; ) {
    ...
    a === -1 ? (!(l & n) || l & r) && (i[s] = Gp(l, t)) : a <= t && (e.expiredLanes |= l), o &= ~l;
  }
}
function al(e) {
...
var ed, sa, td, nd, rd, ul = !1, ji = [], qt = null, Jt = null, bt = null, Gr = /* @__PURE__ */ new Map(), Xr = /* @__PURE__ */ new Map(), Ht = [], qp = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
function su(e, t) {
  switch (e) {
    case "focusin":
    case "focusout":
...
function bp() {
  ul = !1, qt !== null && Ki(qt) && (qt = null), Jt !== null && Ki(Jt) && (Jt = null), bt !== null && Ki(bt) && (bt = null), Gr.forEach(lu), Xr.forEach(lu);
}
function Er(e, t) {
...
var Gt = null, aa = null, qi = null;
function sd() {
  if (qi)
    return qi;
  var e, t = aa, n = t.length, r, i = "value" in Gt ? Gt.value : Gt.textContent, o = i.length;
...
function Nh(e, t) {
  if (Bn)
    return e === "compositionend" || !da && ad(e, t) ? (e = sd(), qi = aa = Gt = null, Bn = !1, e) : null;
  switch (e) {
    case "paste":
      return null;
    case "keypress":
...
function Ts(e, t, n, r, i) {
  ...
  Hc(function() {
    ...
    if (!(t & 7)) {
      ...
      E && (ld && n.locale !== "ko" && (Bn || E !== "onCompositionStart" ? E === "onCompositionEnd" && Bn && (C = sd()) : (Gt = p, aa = "value" in Gt ? Gt.value : Gt.textContent, Bn = !0)), S = mo(u, E), 0 < S.length && (E = new cu(E, e, null, n, p), h.push({ event: E, listeners: S }), C ? E.data = C : (C = ud(n), C !== null && (E.data = C)))), (C = Ch ? Th(e, n) : Nh(e, n)) && (u = mo(u, "onBeforeInput"), 0 < u.length && (p = new cu("onBeforeInput", "beforeinput", null, n, p), h.push({ event: p, listeners: u }), p.data = C));
    }
    kd(h, t);
  });
}
...
function b(e) {
  0 > Gn || (e.current = gl[Gn], gl[Gn] = null, Gn--);
}
function G(e, t) {
  Gn++, gl[Gn] = e.current, e.current = t;
}
...
function go(e) {
  return e = (e = e.stateNode) && e.__reactInternalMemoizedMergedChildContext || ln, Cn = Ce.current, G(Ce, e), G(ze, ze.current), !0;
}
function Nu(e, t, n) {
  var r = e.stateNode;
  if (!r)
...
function ka(e, t) {
  switch (G(ri, t), G(ni, e), G(gt, Ni), e = t.nodeType, e) {
    case 9:
    case 11:
...
}, nm = { readContext: qe, useCallback: Qd, useContext: qe, useEffect: Na, useImperativeHandle: Yd, useInsertionEffect: Zd, useLayoutEffect: Bd, useMemo: Gd, useReducer: Ds, useRef: Ud, useState: function() {
  return Ds(oi);
...
function lf(e, t, n) {
  ...
  if ((l = s) || (l = e !== null && e.memoizedState === null ? !1 : (i & 2) !== 0), l ? (o = !0, t.flags &= -129) : (e === null || e.memoizedState !== null) && (i |= 1), G(ne, i & 1), e === null)
...
function om(e, t, n, r, i, o, s) {
  ...
  return i.data === "$?" ? (t.flags |= 128, t.child = e.child, t = gm.bind(null, e), i._reactRetry = t, null) : (e = o.treeContext, $e = en(i.nextSibling), Ue = t, ee = !0, nt = null, e !== null && (Qe[Ge++] = Pt, Qe[Ge++] = Lt, Qe[Ge++] = Tn, Pt = e.id, Lt = e.overflow, Tn = t), t = Pa(t, r.children), t.flags |= 4096, t);
}
function Bu(e, t, n) {
  e.lanes |= t;
  var r = e.alternate;
  ...
  switch (t.tag) {
    ...
    case 13:
      if (r = t.memoizedState, r !== null)
        return r.dehydrated !== null ? (G(ne, ne.current & 1), t.flags |= 128, null) : n & t.child.childLanes ? lf(e, t, n) : (G(ne, ne.current & 1), e = At(e, t, n), e !== null ? e.sibling : null);
      G(ne, ne.current & 1);
      break;
    case 19:
...
function lm(e, t, n) {
  ...
  switch (ha(t), t.tag) {
    ...
    case 19:
      ...
      return o.tail !== null ? (t = o.tail, o.rendering = t, o.tail = t.sibling, o.renderingStartTime = ae(), t.sibling = null, n = ne.current, G(ne, r ? n & 1 | 2 : n & 1), t) : (xe(t), null);
    case 22:
    case 23:
...
function mf(e, t) {
  ...
  switch (e.tag) {
    ...
    case 4:
      ...
      break;
    case 13:
      be(t, e), ht(e), i = e.child, i.flags & 8192 && (o = i.memoizedState !== null, i.stateNode.isHidden = o, !o || i.alternate !== null && i.alternate.memoizedState !== null || (Da = ae())), r & 4 && Qu(e);
      break;
    case 22:
...
var fm = Math.ceil, No = Vt.ReactCurrentDispatcher, La = Vt.ReactCurrentOwner, Ke = Vt.ReactCurrentBatchConfig, W = 0, ve = null, ce = null, we = 0, We = 0, bn = pn(0), fe = 0, li = null, On = 0, bo = 0, Ra = 0, Zr = null, Me = null, Da = 0, pr = 1 / 0, Tt = null, Oo = !1, Il = null, nn = null, Bi = !1, Xt = null, Po = 0, Br = 0, jl = null, ro = -1, io = 0;
function Pe() {
...
function yf(e, t) {
  ...
  if (t !== 0) {
    if (t === 2 && (i = al(e), i !== 0 && (r = i, t = zl(e, i))), t === 1)
      throw n = li, Sn(e, 0), Yt(e, r), Fe(e, ae()), n;
    if (t === 6)
      Yt(e, r);
    else {
      ...
      switch (e.finishedWork = i, e.finishedLanes = r, t) {
        ...
        case 2:
          ...
          break;
        case 3:
          if (Yt(e, r), (r & 130023424) === r && (t = Da + 500 - ae(), 10 < t)) {
            if (fo(e, 0) !== 0)
              break;
...
function qu(e) {
  ...
  if (n === 1)
    throw n = li, Sn(e, 0), Yt(e, t), Fe(e, ae()), n;
  if (n === 6)
    throw Error(g(345));
...
function ym(e, t, n) {
  var r = e.pingCache;
  r !== null && r.delete(t), t = Pe(), e.pingedLanes |= e.suspendedLanes & n, ve === e && (we & n) === n && (fe === 4 || fe === 3 && (we & 130023424) === we && 500 > ae() - Da ? Sn(e, 0) : Ra |= n), Fe(e, t);
}
function Sf(e, t) {
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 && (oa(t, n | 1), Fe(t, ae()), !(W & 6) && (pr = ae() + 500, hn()));
      }
      break;
    case 13:
      Pn(function() {
...
let Xm = 0;
const Ul = () => ++Xm, Mf = 0, If = 1, jf = 2, Km = 3;
var Pr = {
  __proto__: null,
...
const ic = (e, t) => {
  ...
  null,
  (e[1] === null ? e[2] : e[1]) || {}
], a0 = () => an(t0, ue.useContext(r0)), u0 = (e) => (t, n, r) => e(t, n && ((...o) => {
...
const oc = Zo.use || ((e) => {
  ...
  const { cache: r, compare: i, suspense: o, fallbackData: s, revalidateOnMount: l, revalidateIfStale: a, refreshInterval: u, refreshWhenHidden: p, refreshWhenOffline: h, keepPreviousData: m } = n, [y, w, k, F] = Ot.get(r), [d, c] = Ua(e), f = ue.useRef(!1), v = ue.useRef(!1), x = ue.useRef(d), S = ue.useRef(t), C = ue.useRef(n), E = () => C.current, H = () => E().isVisible() && E().isOnline(), [D, pe, ct, Ve] = Df(r, d), he = ue.useRef({}).current, as = $(s) ? n.fallback[d] : s, zn = (K, q) => {
    for (const ke in he) {
      const se = ke;
      if (se === "data") {
  ...
  ), An[0], An[1]), M = !f.current, z = y[d] && y[d].length > 0, Y = T.data, X = $(Y) ? as : Y, St = T.error, dt = ue.useRef(X), Wt = m ? $(Y) ? dt.current : Y : X, ft = z && !$(St) ? !1 : M && !$(l) ? l : E().isPaused() ? !1 : o ? $(X) ? !1 : a : $(X) || a, mn = !!(d && t && M && ft), ep = $(T.isValidating) ? mn : T.isValidating, tp = $(T.isLoading) ? mn : T.isLoading, _r = ue.useCallback(
    async (K) => {
      const q = S.current;
...
}) => Zf((n) => n instanceof e, t), Bf = rt.create, Hf = un.create, D0 = Vo.create, M0 = cn.create, Yf = fi.create, I0 = Ln.create, j0 = jo.create, z0 = pi.create, A0 = hi.create, F0 = mr.create, V0 = En.create, W0 = Ft.create, $0 = zo.create, U0 = lt.create, Z0 = te.create, B0 = te.strictCreate, H0 = mi.create, Y0 = ss.create, Q0 = vi.create, G0 = _t.create, X0 = yi.create, K0 = Ao.create, q0 = Rn.create, J0 = sr.create, b0 = gi.create, ev = wi.create, tv = dn.create, nv = _i.create, rv = vr.create, lc = ut.create, iv = Mt.create, ov = Dn.create, sv = ut.createWithPreprocess, lv = Oi.create, av = () => Bf().optional(), uv = () => Hf().optional(), cv = () => Yf().optional(), dv = {
...
const Qf = le.object({
  MemberCount: le.number(),
  OnTrackCount: le.number()
}), Gf = le.object({
  MemberCount: le.number(),
  ContributionAmount: le.number()
}), Xf = le.object({
  ContributionAmount: le.number()
}), pv = le.object({
  Name: le.string(),
  ...
  DateFrom: le.string(),
  DateTo: le.string(),
  MyShareTargetOnDate: le.number(),
  MyShareNextThreshold: le.number(),
  SamvirkGoalPerMonth: le.number(),
  SamvirkGoalPerSprint: le.number(),
  Teams: le.array(pv)
}), mv = le.array(hv);
Qf.or(Gf).or(Xf);
function kt(e) {
...
const hc = (e) => {
  ...
  const e = document.getElementById("work-root").getAttribute("data-source-url"), { data: t, error: n, isLoading: r } = h0(e, zy);
