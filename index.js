...
function vm(e, t, n, r) {
  ...
  if (Kp(e, o), e === ve && (ce = ve = null, we = 0), !(n.subtreeFlags & 2064) && !(n.flags & 2064) || Bi || (Bi = !0, Ef(co, function() {
    ...
    B = 1;
    var a = W;
    W |= 4, Ll.current = null, cm(e, n), mf(n, e), zh(ha), po = !!pa, ha = pa = null, e.current = n, dm(n), $p(), W = a, B = s, Ke.transition = o;
  } else
    e.current = n;
...
function or() {
  if (Xt !== null) {
    ...
    try {
      if (Ke.transition = null, B = 16 > e ? 16 : e, Xt === null)
        var r = !1;
      else {
...
const oc = Zo.use || ((e) => {
  ...
  const { cache: r, compare: i, suspense: o, fallbackData: s, revalidateOnMount: a, revalidateIfStale: l, refreshInterval: u, refreshWhenHidden: p, refreshWhenOffline: h, keepPreviousData: m } = n, [y, w, k, F] = Ot.get(r), [d, c] = Ul(e), f = ue.useRef(!1), v = ue.useRef(!1), x = ue.useRef(d), S = ue.useRef(t), C = ue.useRef(n), E = () => C.current, H = () => E().isVisible() && E().isOnline(), [D, pe, dt, Ve] = Df(r, d), he = ue.useRef({}).current, ls = $(s) ? n.fallback[d] : s, zn = (K, q) => {
    for (const ke in he) {
      const se = ke;
      if (se === "data") {
    ...
    }, ke = D(), se = Ve(), ht = q(ke), Fn = ke === se ? ht : q(se);
    let ye = ht;
    return [
      () => {
        const Ne = q(D());
  ...
  ), An[0], An[1]), M = !f.current, z = y[d] && y[d].length > 0, Y = T.data, X = $(Y) ? ls : Y, xt = T.error, ft = ue.useRef(X), Wt = m ? $(Y) ? ft.current : Y : X, pt = z && !$(xt) ? !1 : M && !$(a) ? a : E().isPaused() ? !1 : o ? $(X) ? !1 : l : $(X) || l, mn = !!(d && t && M && pt), ep = $(T.isValidating) ? mn : T.isValidating, tp = $(T.isLoading) ? mn : T.isLoading, _r = ue.useCallback(
    async (K) => {
      const q = S.current;
...
const Qf = ae.object({
  MemberCount: ae.number(),
  OnTrackCount: ae.number()
}), Gf = ae.object({
  MemberCount: ae.number(),
  ContributionAmount: ae.number()
}), Xf = ae.object({
  ContributionAmount: ae.number()
}), pv = ae.object({
  Name: ae.string(),
  ...
  DateFrom: ae.string(),
  DateTo: ae.string(),
  MyShareTargetOnDate: ae.number(),
  MyShareNextThreshold: ae.number(),
  SamvirkGoalPerMonth: ae.number(),
  SamvirkGoalPerSprint: ae.number(),
  Teams: ae.array(pv)
}), mv = ae.array(hv);
Qf.or(Gf).or(Xf);
function St(e) {
...
const hc = (e) => {
  ...
  const e = document.getElementById("work-root").getAttribute("data-source-url"), { data: t, error: n, isLoading: r } = h0(e, Fy);
  return console.log(t, n, r), /* @__PURE__ */ Q.jsxs("div", { className: et.app, children: [
    r && /* @__PURE__ */ Q.jsx("p", { className: et.loading, children: "Ladataan dataa..." }),
    n && /* @__PURE__ */ Q.jsxs("p", { className: et.error, children: [
      "Virhe: ",
      `${n}`
    ] }),
            ...
            children: [
              ...
              /* @__PURE__ */ Q.jsx("tbody", { children: i.Teams.map((o) => /* @__PURE__ */ Q.jsxs("tr", { children: [
                ...
                /* @__PURE__ */ Q.jsx("td", { children: Hs(
                  o.SamvirkStatus,
                  i.SamvirkGoalPerSprint
                ) }),
                /* @__PURE__ */ Q.jsx("td", { children: Sy(o, i.SamvirkGoalPerSprint) })
              ] }, o.Name)) })
            ]
          }
        )
...
$y.render(
  /* @__PURE__ */ Q.jsx(Zo.StrictMode, { children: /* @__PURE__ */ Q.jsx(Vy, {}) })
);
